/**
 * @file backend_xenos.cpp
 * @brief PowerVR Xenos GPU Backend Implementation (mobile)
 *
...
BackendPVR::BackendPVR()
    : initialized_(false), name_("PowerVR_XE"), caps_() {
    std::memset(&caps_, 0, sizeof(caps_));
}

BackendPVR::~BackendPVR() { shutdown(); }

NRRResult BackendPVR::initialize(const NRRDeviceOptions&) {
...
void BackendPVR::shutdown() { initialized_ = false; }
...
NRRResult BackendPVR::create_texture(const NRRTextureDesc&, void*&) {
    return initialized_ ? NRR_SUCCESS : NRR_ERROR_STATE_INVALID;
}
void BackendPVR::destroy_texture(void*) {}
NRRResult BackendPVR::upload_texture(void*, const void*, size_t) {
    return initialized_ ? NRR_SUCCESS : NRR_ERROR_STATE_INVALID;
}
NRRResult BackendPVR::download_texture(void*, void*, size_t) {
    return initialized_ ? NRR_SUCCESS : NRR_ERROR_STATE_INVALID;
}
NRRResult BackendPVR::create_buffer(const NRRBufferDesc&, void*&) {
    return initialized_ ? NRR_SUCCESS : NRR_ERROR_STATE_INVALID;
}
void BackendPVR::destroy_buffer(void*) {}
NRRResult BackendPVR::upload_buffer(void*, const void*, size_t, size_t) {
    return initialized_ ? NRR_SUCCESS : NRR_ERROR_STATE_INVALID;
}
NRRResult BackendPVR::download_buffer(void*, void*, size_t, size_t) {
    return initialized_ ? NRR_SUCCESS : NRR_ERROR_STATE_INVALID;
}

NRRResult BackendPVR::load_model(ModelImpl* model) {
...
NRRResult BackendPVR::unload_model(ModelImpl* model) {
    MobileExecutionKernel* kernel = get_mobile_kernel();
    if (kernel) kernel->unload_model(model);
    return NRR_SUCCESS;
}

NRRResult BackendPVR::execute_model(ModelImpl* model, const NRRFrameInput& input,
...
NRRResult BackendPVR::load_reference(ReferenceImpl*) {
    return initialized_ ? NRR_SUCCESS : NRR_ERROR_STATE_INVALID;
}
NRRResult BackendPVR::unload_reference(ReferenceImpl*) {
    return initialized_ ? NRR_SUCCESS : NRR_ERROR_STATE_INVALID;
}
NRRResult BackendPVR::wait_idle() { return NRR_SUCCESS; }
