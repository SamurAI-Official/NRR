/**
 * @file backend_radeon_mob.h
 * @brief AMD/ATI Radeon Mobile GPU Backend (mobile)
 */

#ifndef NRR_MOBILE_BACKEND_RADEON_MOB_H
#define NRR_MOBILE_BACKEND_RADEON_MOB_H

#include "nrr_backend.h"

namespace nrr {

class BackendRadeonMob : public Backend {
public:
    BackendRadeonMob();
    ~BackendRadeonMob() override;
